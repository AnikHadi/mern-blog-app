      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1 px-5 py-5 shadow-2xl rounded-xl">
          ...
          <form action={formAction} className="flex flex-col gap-4">
            ...
            <Button
              className="transition group flex items-center justify-center text-white font-bold rounded-md p-[1.5px] bg-gradient-to-br from-purple-600 to-pink-600 hover:from-pink-600 hover:to-purple-600 cursor-pointer mt-px mr-[1px] select-none"
              type="submit"
              disabled={isPending}
            >
